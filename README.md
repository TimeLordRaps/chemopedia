...
The venturi iNO device design (Venturi NO Mixer for inhaled nitric oxide without electronics — described in `narrative.md`) is additionally released to the public domain under CC0. No conditions. No restrictions.
